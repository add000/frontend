...
export default function EditRolePage() {
  ...
  const fetchRole = async () => {
    try {
      ...
      Swal.fire('Error', 'Cannot fetch role data', 'error');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire('Error', 'Cannot update role', 'error');
    } finally {
      setSaving(false);
    }
  };
            ...
            >
              <div className="card-body">
                <div className="d-flex justify-content-between align-items-center mb-4">
                  ...
                  <Link href="/admin/roles" className="btn btn-outline-light rounded-5">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      required
                      disabled={!isAdmin || formData.name === 'admin'} // ป้องกันการแก้ไข admin
                    />
                  </div>
                  ...
                  <div className="d-flex gap-2">
                    <button
                      ...
                      disabled={saving || !isAdmin || formData.name === 'admin'}
                    >
                      {saving ? (
                        <>
                        ...
                        <>
                          <i className="fa fa-save me-1"></i> Update Role
                        </>
                      )}
                    </button>
                    <Link href="/admin/roles" className="btn btn-outline-light rounded-5">
